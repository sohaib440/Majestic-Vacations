        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed">
              Creating unforgettable travel experiences since 2010. Let us take
              you on a journey to the world's most beautiful destinations.
            </p>

            {/* Social Links */}
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/Themajesticvacations"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/themajesticvacations/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.tiktok.com/@themajesticvacations"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="hover:text-accent transition-colors"
